...
public class MessageController implements CommunityConstant {
    ...
    public String getLetterList(Model model, Page page) {
        ...
        List<Message> conversationList = messageService.findConversations(
                user.getId(), page.getOffset(), page.getPageLimit());
    ...
    public String getLetterDetail(@PathVariable("conversationId") String conversationId, Page page, Model model) {
        ...
        // 私信列表
        List<Message> letterList = messageService.findLetters(conversationId, page.getOffset(), page.getPageLimit());
    ...
    public String getNoticeDetail(@PathVariable("topic") String topic, Page page, Model model) {
        ...
        List<Message> noticeList = messageService.findNotices(user.getId(), topic, page.getOffset(), page.getPageLimit());
